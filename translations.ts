...
export const translations = {
  ...
  ar: {
    ...
    sanctuary: "المحراب",
    introText: "استخلاص عصبي للحكمة البديهية من بطون المخطوطات الغائرة",
    ...
    synthesis: "توليف معرفي...",
    covenant: "ميثاق المحراب: الاستيعاب المباشر هو السبيل الأوحد لفك مغاليق الحكمة.",
    about: "عن المنظومة",
    help: "الإرشاد",
