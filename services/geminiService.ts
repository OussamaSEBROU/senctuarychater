...
3. Extract the DEEP INTELLECTUAL CONTEXT and core arguments of this PDF accurately.
...
Return ONLY JSON.`;
    ...
    fullManuscriptText = result.metadata?.deepContext || "";
